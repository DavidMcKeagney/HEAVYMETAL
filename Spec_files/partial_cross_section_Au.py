...
#%% 5P1_2 plots
plt.plot(partial_AuII_5d96s_2_5_5P1_2[:,0],partial_AuII_5d96s_2_5_5P1_2[:,1],label='AuII: 5d96s, j_6s=5/2')
plt.plot(partial_AuII_5P1_2[:,0],partial_AuII_5P1_2[:,1],label='AuII: 5d10')
plt.plot(partial_AuI_5d96s2_1_5_5P1_2[:,0],partial_AuI_5d96s2_1_5_5P1_2[:,1],label='AuI: 5d96s2, j_6s=3/2')
plt.plot(partial_AuI_5d96s2_2_5_5P1_2[:,0],partial_AuI_5d96s2_2_5_5P1_2[:,1],label='AuI: 5d96s2, j_6s=5/2')
plt.xlabel('Energy')
plt.ylabel('Intensity')
plt.title('5P1_2')
plt.legend()
#%% 6S1_2 plots
plt.plot(partial_AuII_5d86s2_1_5_6S1_2[:,0],partial_AuII_5d86s2_1_5_6S1_2[:,1],label='AuII: 5d86s2 2 x j_6s=3/2')
plt.plot(partial_AuII_5d86s2_2_5_1_5_6S1_2[:,0],partial_AuII_5d86s2_2_5_1_5_6S1_2[:,1],label='AuII: 5d86s2 j_6s=3/2, j_6s=5/2')
plt.plot(partial_AuII_5d86s2_2_5_6S1_2[:,0],partial_AuII_5d86s2_2_5_6S1_2[:,1],label='AuII: 5d86s2 2 x j_6s=5/2')
plt.plot(partial_AuII_5d96s_2_5_6S1_2[:,0],partial_AuII_5d96s_2_5_6S1_2[:,1],label='AuII: 5d96s j_6s= 5/2')
plt.xlabel('Energy')
plt.ylabel('Intensity')
plt.title('6S1_2')
plt.legend()
#%% 5P3_2 plots
plt.plot(partial_AuII_5d86s2_1_5_5P3_2[:,0],partial_AuII_5d86s2_1_5_5P3_2[:,1],label='AuII: 5d86s2 j_6s=3/2')
plt.plot(partial_AuII_5d86s2_2_5_1_5_5P3_2[:,0],partial_AuII_5d86s2_2_5_1_5_5P3_2[:,1],label='AuII: 5d86s2 j_6s=3/2,j_6s=5/2')
plt.plot(partial_AuII_5d86s2_2_5_5P3_2[:,0],partial_AuII_5d86s2_2_5_5P3_2[:,1],label='AuII: 5d86s2 j_6s=5/2')
plt.plot(partial_AuII_5d96s_1_5_5P3_2[:,0],partial_AuII_5d96s_1_5_5P3_2[:,1],label='AuII: 5d96s j_6s=3/2')
plt.plot(partial_AuII_5d96s_2_5_5P3_2[:,0],partial_AuII_5d96s_2_5_5P3_2[:,1],label='AuII: 5d96s j_6s=5/2')
plt.plot(partial_AuI_5d96s2_1_5_5P3_2[:,0],partial_AuI_5d96s2_1_5_5P3_2[:,1],label='AuI: 5d96s2 j_6s=3/2')
plt.plot(partial_AuI_5d96s2_2_5_5P3_2[:,0],partial_AuI_5d96s2_2_5_5P3_2[:,1],label='AuI: 5d96s2 j_6s=5/2')
plt.xlabel('Energy')
plt.ylabel('Intensity')
plt.title('5P3_2')
plt.legend()
