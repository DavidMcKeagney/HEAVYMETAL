...
Abs_500ns=np.loadtxt('C:\\Users\padmin\OneDrive\Desktop\OneDrive_1_26-05-2026\\2023_07_13_113.csv',dtype=str,delimiter=',')
Abs_450ns=np.loadtxt('C:\\Users\padmin\OneDrive\Desktop\OneDrive_1_26-05-2026\\2023_07_13_112.csv',dtype=str,delimiter=',')
Abs_400ns=np.loadtxt('C:\\Users\padmin\OneDrive\Desktop\OneDrive_1_26-05-2026\\2023_07_13_112.csv',dtype=str,delimiter=',')
...
plt.plot(Energy+np.repeat(11,len(Energy)),1/400*Hf_II,label='Hf II')
