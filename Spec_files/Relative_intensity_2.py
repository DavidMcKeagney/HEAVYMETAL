...
spec_file_1_1_5=[]
with open('C:/Users/David McKeagney/Desktop/au1.sub.1.5.spec') as file:
    for lines in file:
        if len(lines.split())>17:
            spec_file_1_1_5.append(lines.split())
spec_file_1_1_5=np.array(spec_file_1_1_5)[1:,:]
Eric_data_500ns=np.loadtxt('C:/Users/David McKeagney/Downloads/Eric_data_500ns.txt',dtype=float).T
Intensity_500ns=Eric_data_500ns[1][np.logical_and(Eric_data_500ns[0]>=80,Eric_data_500ns[0]<=110)]
Energy_500ns=Eric_data_500ns[0][np.logical_and(Eric_data_500ns[0]>=80,Eric_data_500ns[0]<=110)]
#%%
...
#%%
auspec_1_1_1_5=spec_file_1_1_5[spec_file_1_1_5[:,8]=='1']
auspec_5_1_1_5=spec_file_1_1_5[spec_file_1_1_5[:,8]=='5']
auspec_9_1_1_5=spec_file_1_1_5[spec_file_1_1_5[:,8]=='9']
auspec_1_1_1_5=np.concatenate((auspec_1_1_1_5,auspec_5_1_1_5),axis=0)
spec_file_1_1_5=np.concatenate((auspec_1_1_1_5,auspec_9_1_1_5),axis=0)       
#%%
...
#%%
upper_levels_1=list(set(spec_file_1_1_5[:,6].astype(float)))
gf_vals_1_1_5=[]
decay_vals_1_1_5=[]
for ul in upper_levels_1:
    temp_spec=spec_file_1_1_5[spec_file_1_1_5[:,6].astype(float)==ul]
    gf_temp=np.exp(temp_spec[:,15].astype(float))
    decay_temp=temp_spec[:,16].astype(float)*1e-3
    gf_vals_1_1_5.append(sum(gf_temp))
    decay_vals_1_1_5.append(sum(decay_temp))
#%%
...
conv_vals_1_1_5=flp.ConvolvingFunc(1, Energy, np.array(upper_levels_1), np.array(gf_vals_1_1_5), 0.05, np.array(decay_vals_1_1_5), 3)
#%%
plt.plot(Energy+np.repeat(0.3,len(Energy)),0.4*(0.95*conv_vals_1_5+0.05*conv_vals_1_1_5),label='T=1.5')
#plt.plot(Energy+np.repeat(0.3,len(Energy)),0.4*(0.15*conv_vals_1_1_5),label='T=1.5 Au1+')
