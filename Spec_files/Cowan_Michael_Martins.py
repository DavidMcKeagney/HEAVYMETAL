...
#%%
total_cross_sections_AuI=TotalCrossSection2(list_of_arrays_AuI,list_of_arrays_AuI)
total_cross_sections_AuII=TotalCrossSection2(list_of_arrays_AuII,list_of_weights_AuII)
#%%
